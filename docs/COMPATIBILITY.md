...
| --- | --- | --- | --- |
| Iva | 0.3.34 | MCP manifest compatibility and historical live use | supported |
| Iva | 0.4.0 | install/update lifecycle, `iva doctor` and MCP proxy smoke test | supported |
