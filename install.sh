...
say "2. В разделе для разработчиков создайте входящий webhook."
say "3. Выдайте webhook доступ только к задачам. Администраторские права не нужны."
say "4. Скопируйте полный URL вида https://ваш-портал/rest/ID/СЕКРЕТ."
say ""
