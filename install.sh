...
say "4. На шаге Права доступа (Assign permissions) обязательно добавьте Задачи — scope task."
say "5. Для полного чтения дополнительно можно добавить:"
say "   Чат и уведомления (im) — обсуждения новой карточки задачи;"
say "   Рабочие группы социальной сети (sonet_group) — проекты и группы;"
say "   Пользователи (минимальные) (user_brief) — имена без контактов;"
...
say "6. Скопируйте полный URL вида https://ваш-портал/rest/ID/СЕКРЕТ."
say ""
...
say ""
say "  ${bold}Проверь подключение и покажи возможности Bitrix24${reset}"
say ""
say "Ива проверит соединение и покажет, какие read-возможности доступны с правами webhook."
